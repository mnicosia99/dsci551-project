...
export class CesiumDirective implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dataService.sendGetRequestShelters().subscribe((shelters: Shelters) => {
      shelters.shelters.forEach((shelter: Shelter) => {
        if (shelter.coordinates != undefined) {
          ...
          viewer.entities.removeById(shelter.shelter_name)
    ...
    viewer.camera.moveEnd.addEventListener( () => {
      ...
      if (viewer.camera.positionCartographic.height < 2500000 && 
        viewer.camera.positionCartographic.height > 2000000) {
          console.log("not clearing")
          if (viewer.entities.getById("fundinggt3000") != undefined) {
            viewer.entities.getById("fundinggt3000").show = true;
          } 
          if (viewer.entities.getById("fundinglt3000") != undefined) {
            viewer.entities.getById("fundinglt3000").show = true;
          } 
          if (viewer.entities.getById("fundinglt1200") != undefined) {
            viewer.entities.getById("fundinglt1200").show = true;
          } 
          if (viewer.entities.getById("fundinglt500") != undefined) {
            viewer.entities.getById("fundinglt500").show = true;
          } 
          if (viewer.entities.getById("fundinglt100") != undefined) {
            viewer.entities.getById("fundinglt100").show = true;
          }
      } else {
        console.log("clearing")
        if (viewer.entities.getById("fundinggt3000") != undefined) {
          viewer.entities.getById("fundinggt3000").show = false;
        } 
        if (viewer.entities.getById("fundinglt3000") != undefined) {
          viewer.entities.getById("fundinglt3000").show = false;
        } 
        if (viewer.entities.getById("fundinglt1200") != undefined) {
          viewer.entities.getById("fundinglt1200").show = false;
        } 
        if (viewer.entities.getById("fundinglt500") != undefined) {
          viewer.entities.getById("fundinglt500").show = false;
        } 
        if (viewer.entities.getById("fundinglt100") != undefined) {
          viewer.entities.getById("fundinglt100").show = false;
        }
      }
